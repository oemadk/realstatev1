<?php
class ControllerAgentMail extends Controller {
	...
	private  function getList(){
		...
		$filter_data = array(
			...
			$results = $this->model_property_agent->getAgents2($filter_data);
		...
		$this->response->setOutput($this->load->view('agent/agent_list2', $data));

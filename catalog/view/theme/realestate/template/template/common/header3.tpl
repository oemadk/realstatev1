	...
	<div class="container">
		<div id="top-links" class="nav">
			<ul class="list-inline pull-left">
				<li><ul class="list-inline social">
					<?php if($fburl){?>
						<li class="fb"><a href="<?php echo $fburl;?>" target="new"><i class="fa fa-facebook" aria-hidden="true"></i> </a></li>
					<?php } ?>
					<?php if($twet){?>
						<li class="twitter"><a href="<?php echo $twet;?>" target="new" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i> </a></li>
					<?php }?>
					<?php if($google){?>
						<li class="google"><a href="<?php echo $google;?>" target="new" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i> </a></li>
					<?php } ?>
					<?php if($pinterest){?>
						<li class="pinterest"><a href="<?php echo $pinterest;?>" target="new" class="pinterest"><i class="fa fa-pinterest-p" aria-hidden="true"></i> </a></li>
					<?php }?>
					<?php if($instagram){?>
						<li class="instagram"><a href="<?php echo $instagram;?>" target="new" class="instagram"><i class="fa fa-instagram" aria-hidden="true"></i> </a></li>
					<?php } ?>
					</ul>
				</li>
				<?php if ($logged) { ?>

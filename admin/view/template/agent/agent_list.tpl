         ...
         <div class="row">
            <div class="col-sm-4">
               <div class="form-group">
                  <label class="control-label" for="input-name"><?php echo $filterlable_name; ?></label>
                  <input type="text" name="filter_agentname" value="<?php echo $filter_agentname; ?>" placeholder="<?php echo $filterlable_name; ?>" id="input-name" class="form-control" />
               </div>
            </div>
            <div class="col-sm-4">
               <div class="form-group">
            ...
            <div class="col-sm-3">
               <div class="form-group">
                  <label class="control-label" for="input-status"><?php echo $filterlable_status; ?></label>
            ...
            <table class="table table-bordered table-hover">
               <thead>
                  <tr>
                     ...
                     <td class="text-left"><?php if ($sort == 'sort_status') { ?>
